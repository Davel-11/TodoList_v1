...
public class ModelTable1 extends model_database_con{
    ...
    public ArrayList<Object> getList(String UserInfo) throws SQLException // done
    {
        try {            
            con();
     ...
     public ArrayList<Object> getID(String UserInfo) throws SQLException // done
    {
         try {
            con();
    ...
    public void removeItem(String UserInfo, int iditem) throws SQLException  // done
    {
        try {
            con();
